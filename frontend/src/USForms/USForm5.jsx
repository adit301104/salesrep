      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-8">
          ...
          <ol className="list-decimal pl-6 space-y-4">
            ...
            <li>The dealer agrees to provide the discount stated above to all the members of Autowiz during the term of this contract.</li>
            <li>The dealer shall provide refunds and guarantees to all Autowiz members as per the standard policies of the dealership.</li>
            <li>The dealer and Autowiz agree that all client lists, garages, members, individuals, businesses or entities introduced by one to the other shall remain the property of the introducing party.</li>
            <li>All transactions between the parties may be done via the platform except for payments which shall be according to dealer procedures.</li>
          </ol>
        </div>
