...
const USForm3 = () => {
  ...
  const clientSignatureInputRef = useRef(null);
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        if (type === 'representative') {
          ...
          setClientSignature(event.target.result);
        }
      };
  ...
  const handleClearSignature = (type) => {
    if (type === 'representative') {
      ...
      if (clientSignatureInputRef.current) {
        clientSignatureInputRef.current.value = "";
      }
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showNotificationMessage("success", "Auto Parts Service Contract submitted successfully!");
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-8">
          <div className="mb-4">
            <label className="font-semibold mr-2">SERVICE:</label>
            <input
              type="text"
              name="service"
          ...
          <div className="flex space-x-6 mb-4">
            ...
            <div className="flex-1">
              <label className="font-semibold mr-2">Monthly Cost + Taxes:</label>
              <input
                type="text"
                name="monthlyCost"
          ...
          <div className="mb-4">
            <label className="font-semibold mr-2">Date of monthly withdrawals:</label>
            <input
              type="text"
            ...
            <div className="w-1/2 pl-8">
              ...
              <div className="mb-2">
                {clientSignature ? (
                  ...
                  <div className="flex flex-col print:hidden">
                    <label className="text-sm text-gray-600 mb-1">Upload Client Signature:</label>
                    <input 
                      type="file" 
