    ...
    <div className="p-6 max-w-4xl mx-auto bg-white">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2 text-sm bg-gray-50 p-4 rounded-lg">
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>Ce contrat se renouvelle automatiquement pour une durée équivalente sauf si le client ou Autowiz décide de ne pas renouveler ce contrat dans les 30 jours avant la fin de cette entente.</li>
            </ol>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          ...
          <div className="flex-1">
            <h3 className="font-medium mb-2">Signature du licencié</h3>
            <div className="border-t-2 border-gray-400 pt-2 mb-4 h-40 flex items-center justify-center bg-gray-50">
            ...
            <p className="text-sm mt-2 text-center">Signature du Licencié</p>
