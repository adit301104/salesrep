  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex flex-col">
              <label htmlFor="service" className="block mb-1">1) SERVICE:</label>
              <textarea
                id="service"
                name="service"
            ...
            <div className="flex flex-col md:flex-row md:gap-4">
              <div className="flex-1">
                <label htmlFor="term" className="block mb-1">2) Term:</label>
                <input
                  type="text"
                  id="term"
                  name="term"
              ...
              <div className="flex-1">
                <label htmlFor="discount" className="block mb-1">3) Discount:</label>
                <input
                  type="text"
                  id="discount"
                  name="discount"
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p>2) The vendor agrees to provide the discount stated above to all the clients of Autowiz during the term of this contract.</p>
              <p>3) The Garage Vendor shall provide refunds and guarantees to all Autowiz clients as per the standard policies of the garage.</p>
              <p>4) The garage Vendor and Autowiz agree that all client lists, garages, individuals, businesses or entities introduced by one to the other shall remain the property of the introducing party.</p>
              <p>5) All transactions between the parties must be done via the platform except for payments which shall be according to Vendor procedures.</p>
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col md:flex-row justify-between mb-8">
              ...
              <div className="flex-1">
                <label className="block font-bold mb-1">Signature of vendor:</label>
                <div className="border p-2 h-32 flex items-center justify-center bg-gray-50 rounded">
      ...
      <div className="hidden print:block">
        ...
        <div className="space-y-4 mb-8">
          <p className="font-bold">1) SERVICE: <span className="font-normal">{formData.service}</span></p>
          <p className="font-bold">2) Term: <span className="font-normal">{formData.term}</span> 3) Discount: <span className="font-normal">{formData.discount}</span></p>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between mt-4">
            ...
            <div>
              {previewVendorSignature && (
                <img src={previewVendorSignature} alt="Vendor Signature" className="h-16" />
              )}
              <p className="mt-1 border-t border-black pt-1">Signature of vendor</p>
