  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.clientLegalName.trim()) {
        throw new Error("Le nom légal du client est requis");
      }
      ...
      const submissionData = {
        formType: "CaForm8Fr",
        title: `Contrat de Service - ${formData.clientLegalName}`,
        fields: {
          ...formData,
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col md:flex-row justify-between mb-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-center text-sm mt-2 text-gray-600">Je suis autorisé à signer pour l'entreprise</p>
              </div>
            </div>
          </div>
      ...
      <div className="hidden print:block">
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between mt-4">
            <div>
              {previewRepresentativeSignature && (
                <img src={previewRepresentativeSignature} alt="Signature du Représentant" className="h-16" />
              )}
              <p className="mt-1 border-t border-black pt-1">Signature du Licensier</p>
            </div>
            <div>
              {previewVendorSignature && (
                <img src={previewVendorSignature} alt="Signature du Client" className="h-16" />
              )}
